...
export function Afterpay({ installmentPrice }: AfterpayProps) {
  return (
    <div
      ...
      <p class="afterpay-paragraph">
        ...
        <span class="afterpay-logo-link">
          <span class="afterpay-logo brand-afterpay lockup-black">
            <svg
          ...
          <button
            onClick={() => {
              const config = {
                modalTheme: window.Afterpay.theme.modal.WHITE,
                size: 'XS',
                logoType: window.Afterpay.logoType.LOCKUP,
              };
              if (!window.Afterpay) {
                window.addEventListener('Afterpay.ready', function () {
                  window.Afterpay?.launchModal(config);
                });
              } else {
                window.Afterpay?.launchModal(config);
              }
